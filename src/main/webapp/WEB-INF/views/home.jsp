...
<head>
    <meta charset="utf-8">
    <title>layuimini-单页版 v2 - 基于Layui的后台管理系统前端模板（改造版）</title>
    ...
    <link rel="icon" href="${ctx}/assets/layuimini/images/favicon.ico">
    <link rel="stylesheet" href="${ctx}/assets/layui/css/layui.css" media="all">
    <link rel="stylesheet" href="${ctx}/assets/layuimini/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <link rel="stylesheet" href="${ctx}/assets/layuimini/css/layuimini.css?v=2.0.1" media="all">
    <link rel="stylesheet" href="${ctx}/assets/layuimini/css/public.css" media="all">
...
<script src="${ctx}/assets/layuimini/js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
